...
from .routers import analysis, cards, centering, collection, demo, fx, health, local_ai, media, owned_cards, prices, processed_images, recognition, settings
...
app.include_router(processed_images.router, prefix="/api")
