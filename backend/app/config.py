...
LOCAL_AI_MODEL_NAME = (os.getenv("LOCAL_AI_MODEL_NAME") or os.getenv("AI_MODEL_NAME") or "").strip()
LOCAL_AI_TIMEOUT_SECONDS = get_int_env("LOCAL_AI_TIMEOUT_SECONDS", 120)
LOCAL_AI_CONNECT_TIMEOUT_SECONDS = get_int_env("LOCAL_AI_CONNECT_TIMEOUT_SECONDS", 30)
LOCAL_AI_READ_TIMEOUT_SECONDS = get_int_env("LOCAL_AI_READ_TIMEOUT_SECONDS", 300)
...
LOCAL_AI_STREAMING_ENABLED = get_bool_env("LOCAL_AI_STREAMING_ENABLED", False)
LOCAL_AI_RESPONSE_FORMAT_TYPE = (
    os.getenv("LM_STUDIO_RESPONSE_FORMAT")
    or os.getenv("LOCAL_AI_RESPONSE_FORMAT")
    or "text"
).strip().lower()
if LOCAL_AI_RESPONSE_FORMAT_TYPE not in {"text", "json_schema"}:
    LOCAL_AI_RESPONSE_FORMAT_TYPE = "text"
...
ENABLE_IMAGE_PREPROCESSING = get_bool_env("ENABLE_IMAGE_PREPROCESSING", True)
ENABLE_CENTERING_DETECTION = get_bool_env("ENABLE_CENTERING_DETECTION", True)
ENABLE_MANUAL_CENTERING_CORRECTION = get_bool_env("ENABLE_MANUAL_CENTERING_CORRECTION", True)
ENABLE_TWO_PHASE_AI_GRADING = get_bool_env("ENABLE_TWO_PHASE_AI_GRADING", True)
SEND_DIAGNOSTIC_IMAGES_TO_AI = get_bool_env("SEND_DIAGNOSTIC_IMAGES_TO_AI", True)

AI_MAX_CONTEXT_TOKENS = get_int_env("AI_MAX_CONTEXT_TOKENS", 15000)
AI_PHASE_A_MAX_OUTPUT_TOKENS = get_int_env("AI_PHASE_A_MAX_OUTPUT_TOKENS", 1500)
AI_PHASE_B_MAX_OUTPUT_TOKENS = get_int_env("AI_PHASE_B_MAX_OUTPUT_TOKENS", 2500)
